...
export default function About() {
  return (
    ...
    >
      <div className="flex flex-col justify-center space-y-4 w-full md:w-1/3 text-lg md:text-2xl px-4">
        <h1>
      ...
      <div className="relative w-3/4 md:w-2/5 h-2/5 md:h-3/5 mt-4 md:mt-0">
