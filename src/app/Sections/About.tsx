...
export default function About() {
  return (
    ...
    >
      <div className="flex flex-col justify-center space-y-4 w-full md:w-1/3 text-lg md:text-2xl text-right">
        <h1>
      ...
      <div className="relative w-3/4 md:w-3/5 h-2/5 md:h-1/2 mt-4 md:mt-0">
