  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center space-y-4 w-full md:w-1/3 text-lg sm:text-xl md:text-2xl text-justify md:text-right px-8 md:px-0">
        <h2 className="text-2xl sm:text-3xl md:text-4xl hidden md:block md:mb-8">
          <span className="underline decoration-wavy font-bold">Who</span> am I?
        </h2>
        <h1>
        ...
        <h1 className="italic">
          ...
          bucket by learning new things every day.
        </h1>
      </div>
