  ...
  return (
    <div className="relative w-screen h-screen bg-[#FBFEF9] text-black border-none">
      ...
      <div className="flex flex-col items-center w-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <div className="flex flex-col justify-center text-3xl sm:text-5xl md:text-6xl">
        ...
        <div className="flex flex-col justify-start items-center text-xl md:text-2xl mt-16 max-h-96 overflow-auto gap-1">
          <h1>
            Hey, I&apos;m{" "}
